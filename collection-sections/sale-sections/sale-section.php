...
<head>
    ...
    <title>Seasonal Sale — Exclusive Discounts</title>
...
:root {
    ...
    --color-sale-text: #991b1b;
    --color-sale-border: #fecaca;
...
<div class="page-wrapper">
    ...
    <div class="main-content-wrapper">
        ...
        <section class="new-arrivals-section" aria-label="Sale Collection">
            <div class="new-arrivals-container">
                <!-- Section Header -->
                <header class="section-header">
                    <span class="section-label">Limited Time Offer</span>
                    <h2 class="section-title">Seasonal Sale</h2>
                    <p class="section-subtitle">Discover our exclusive collection with premium discounts. Quality meets affordability in our seasonal selection.</p>
                </header>
