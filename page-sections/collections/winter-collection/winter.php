...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body { font-family: var(--font-body); background: var(--color-cream); }
        ...
        .order-trigger-btn svg { width: 18px; height: 18px; }
...
.active-filters-bar {
    display: none !important;
        ...
        .order-popup-overlay.active { display: block; opacity: 1; }
        ...
        .order-popup-close:hover { background: var(--color-coffee); color: var(--color-white); }

        .filter-popup-close svg,
        .mini-popup-close svg,
        .order-popup-close svg { width: 16px; height: 16px; }

        .filter-popup-body { padding: 12px 0; }

        .filter-category-item { cursor: pointer; transition: background var(--transition-fast); }
        .filter-category-item:hover { background: var(--color-cream); }
        ...
        .filter-category-header svg { width: 18px; height: 18px; color: var(--color-camel); flex-shrink: 0; }
        .filter-category-header span { flex: 1; }
        .filter-category-header .chevron-icon { width: 14px; height: 14px; color: var(--color-taupe); }
        ...
        .mini-popup.active { opacity: 1; visibility: visible; transform: translateX(0); }
        ...
        .mini-popup-back:hover { background: var(--color-coffee); color: var(--color-white); }
        .mini-popup-back svg { width: 14px; height: 14px; }
        ...
        .mini-popup-body { padding: 12px 16px; display: flex; flex-direction: column; gap: 4px; }
        ...
        .order-popup.active { opacity: 1; visibility: visible; transform: translateY(0); }
        ...
        .order-popup-body { padding: 12px 16px; display: flex; flex-direction: column; gap: 4px; }
        ...
        .order-option:hover { background: var(--color-cream); }
        .order-option input[type="radio"] { display: none; }
        ...
        .order-option input[type="radio"]:checked + .order-radio { border-color: var(--color-coffee); }
        .order-option input[type="radio"]:checked + .order-radio::after { opacity: 1; }
        .order-label { font-size: 0.9rem; color: var(--color-espresso); font-weight: 500; }
        ...
        .filter-option:hover { background: var(--color-cream); }
        ...
        .filter-checkbox svg { width: 12px; height: 12px; color: var(--color-white); opacity: 0; transition: opacity var(--transition-fast); }
        .filter-option input[type="checkbox"]:checked + .filter-checkbox svg { opacity: 1; }

        .filter-label { font-size: 0.9rem; color: var(--color-espresso); font-weight: 500; flex: 1; }
        .filter-count { font-size: 0.75rem; color: var(--color-taupe); font-weight: 600; }

        /* ========================================
           PRICE RANGE
           ======================================== */
        .price-range-container { padding: 0 4px; }

        .price-values { display: flex; justify-content: space-between; margin-bottom: 16px; }
        .price-value { font-size: 0.95rem; font-weight: 600; color: var(--color-coffee); }
        ...
        .clear-all-btn svg { width: 16px; height: 16px; }
        ...
        .filter-pill button:hover { background: rgba(255, 255, 255, 0.5); transform: scale(1.1); }
        .filter-pill button svg { width: 10px; height: 10px; color: var(--color-white); }
        ...
        .new-arrivals-container { max-width: 1400px; margin: 0 auto; }
        ...
        .section-label::after { content: ''; width: 40px; height: 1px; }
        ...
        .section-subtitle { font-size: 1rem; color: var(--color-coffee); max-width: 500px; margin: 0 auto; line-height: 1.7; }
        ...
        .product-image-wrapper:has(.quick-add-popup.active) .quick-actions { opacity: 0 !important; pointer-events: none; }
        .product-image-wrapper:has(.quick-add-popup.active) .wishlist-btn  { opacity: 0 !important; pointer-events: none; }
        ...
        .popup-header h4 { font-family: var(--font-display); font-size: 0.9rem; font-weight: 600; color: var(--color-espresso); margin: 0; }
        ...
        .popup-add-btn:hover { background: var(--color-espresso); transform: translateY(-2px); box-shadow: 0 6px 20px rgba(47, 39, 22, 0.3); }
        ...
        .popup-success h5 { font-family: var(--font-display); font-size: 1.3rem; font-weight: 600; color: var(--color-espresso); margin: 0 0 6px; }
        .popup-success p  { font-size: 0.85rem; color: var(--color-coffee); margin: 0; }

        /* ========================================
           NAV — hidden (grid page, no carousel)
           ======================================== */
        .carousel-nav, .nav-btn, .pagination-dots, .dot { display: none; }
        ...
        .view-all-btn svg { width: 18px; height: 18px; transition: transform var(--transition-fast); }
        ...
        .no-results-icon svg { width: 48px; height: 48px; color: var(--color-coffee); }
        .no-results h3 { font-family: var(--font-display); font-size: 1.8rem; color: var(--color-espresso); margin-bottom: 12px; }
        .no-results p  { font-size: 1rem; color: var(--color-coffee); max-width: 400px; margin: 0 auto; }
        ...
        @media (max-width: 900px) {
            ...
            .top-bar { padding: 20px; flex-direction: column; gap: 16px; align-items: stretch; }
            .results-info { flex-direction: column; gap: 12px; }
            .active-filters-bar { padding: 12px 20px; }
            ...
            .mini-popup.active { transform: translateY(0); }
            ...
            .order-popup.active { transform: translateY(0); }
        }

        @media (max-width: 600px) {
            .carousel-track { grid-template-columns: repeat(1, 1fr); gap: 16px; }
            ...
            .view-all-btn  { padding: 14px 28px; font-size: 0.8rem; }
            .top-bar { padding: 16px; }
            .active-filters-bar { padding: 12px 16px; }
        }
    </style>
</head>
<body>
    ...
    <div class="main-content-wrapper">
        ...
        <div class="filter-popup" id="filterPopup">
            <div class="filter-popup-header">
                <button class="filter-popup-back" id="filterPopupBack" style="display: none; border: none; background: none; cursor: pointer; padding: 0; margin-right: 12px; color: var(--color-espresso);">
                ...
                <h3 id="filterPopupTitle">Filters</h3>
            ...
            <div class="filter-popup-body">
                ...
                <div id="filterStep1">
                    <div class="filter-category-item main-cat-item" data-main-cat="men">
                    ...
                    <div class="filter-category-item main-cat-item" data-main-cat="women">
                        <div class="filter-category-header">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                    ...
                    <div class="filter-category-item main-cat-item" data-main-cat="kids">
                        <div class="filter-category-header">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                    ...
                    <div class="filter-category-item main-cat-item" data-main-cat="accessories">
                        <div class="filter-category-header">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <!-- Step 2: Sub-filters -->
                <div id="filterStep2" style="display: none;">
        ...
        <div class="mini-popup" id="miniPopupCategory">
            ...
            <div class="mini-popup-body">
                <label class="filter-option">
                    ...
                    <span class="filter-checkbox"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg></span>
        ...
        <!-- ═══════════════════════════════════
             ACTIVE FILTER PILLS
        ═══════════════════════════════════ -->
        <div class="active-filters-bar empty" id="activeFiltersBar"></div>
...
<!-- ═══════════════════════════════════════════
     ...
     1. products.js   →  declares mensProducts (and other arrays)
     2. winter-main.js  →  reads mensProducts and drives the UI
═══════════════════════════════════════════ -->
<script src="products.js"></script>
<script src="winter-main.js"></script>
